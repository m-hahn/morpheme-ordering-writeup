...
\node[rectangle,text width=1.2cm,anchor=base] (A2) at (1,-1.5) {Psorperson};
\node[rectangle,text width=1.2cm,anchor=base] (A3) at (1,-2.0) {Psornumber};
\node[rectangle,text width=1.2cm,anchor=base] (A4) at (1,-2.5) {Case};
\node[rectangle,text width=1.2cm,anchor=base] (B1) at (4,-1.0) {Number};
\node[rectangle,text width=1.2cm,anchor=base] (B2) at (4,-1.5) {Psorperson};
\node[rectangle,text width=1.2cm,anchor=base] (B3) at (4,-2.0) {Psornumber};
