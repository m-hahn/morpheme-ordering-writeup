...
\node[rectangle,text width=1.2cm,anchor=base] (B4) at (1,-2.5) {TAM 1};
\node[rectangle,text width=1.2cm,anchor=base] (B5) at (1,-3.0) {Mood};
...
\node[rectangle,text width=1.2cm,anchor=base] (B9) at (1,-5.0) {Agreement};
