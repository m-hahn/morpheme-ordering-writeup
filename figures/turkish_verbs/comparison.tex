...
\node[rectangle,text width=1.2cm,anchor=base] (A3) at (1,-2.0) {POLAR};
...
\node[rectangle,text width=1.2cm,anchor=base] (A9) at (1,-5.0) {Vnoun};
\node[rectangle,text width=1.2cm,anchor=base] (A10) at (1,-5.5) {Agr};
\node[rectangle,text width=1.2cm,anchor=base] (A11) at (1,-6.0) {Gen};
