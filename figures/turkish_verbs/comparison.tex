...
\node[rectangle,text width=1.2cm,anchor=base, fill=purple!20] (B6) at (4,-3.5) {TAM 2};
\node[rectangle,text width=1.2cm,anchor=base, fill=blue!20] (B7) at (4,-4.0) {3Pl};
\node[rectangle,text width=1.2cm,anchor=base, fill=purple!20] (B8) at (4,-4.5) {Genitive};
\node[rectangle,text width=1.2cm,anchor=base] (B9) at (4,-5.0) {Agreement};
