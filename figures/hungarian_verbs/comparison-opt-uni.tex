...
\node[rectangle,text width=1.2cm,anchor=base] (A0) at (4,-0.3) {Real};
...
\node[rectangle,text width=1.2cm,anchor=base] (B4) at (1,-2.5) {Agr};
\node[rectangle,text width=1.2cm,anchor=base] (B5) at (1,-3.0) {Inf};
\draw[-] (A1.west) to (B1.east);
\draw[-] (A2.west) to (B4.east);
