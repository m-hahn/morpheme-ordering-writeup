...
\node[rectangle,text width=1.2cm,anchor=base] (B1) at (1,-1.0) {Object/reflexive};
\node[rectangle,text width=1.2cm,anchor=base] (B2) at (1,-1.5) {Infinitive};
\node[rectangle,text width=1.2cm,anchor=base] (B3) at (1,-2.0) {Int/Rel};
\node[rectangle,text width=1.2cm,anchor=base] (B4) at (1,-2.5) {Negation};
\node[rectangle,text width=1.2cm,anchor=base] (B5) at (1,-3.0) {Tense/aspect};
\node[rectangle,text width=1.2cm,anchor=base] (B6) at (1,-3.5) {Subject};
