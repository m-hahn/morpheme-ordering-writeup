...
\node[rectangle,text width=1.2cm,anchor=base] (B1) at (1,-1.0) {Subject};
\node[rectangle,text width=1.2cm,anchor=base] (B2) at (1,-1.5) {Tense/aspect};
\node[rectangle,text width=1.2cm,anchor=base] (B3) at (1,-2.0) {Negation};
\node[rectangle,text width=1.2cm,anchor=base] (B4) at (1,-2.5) {Int/Rel};
\node[rectangle,text width=1.2cm,anchor=base] (B5) at (1,-3.0) {Infinitive};
\node[rectangle,text width=1.2cm,anchor=base] (B6) at (1,-3.5) {Object/reflexive};
\draw[-] (A6.west) to (B1.east);
\draw[-] (A3.west) to (B2.east);
\draw[-] (A4.west) to (B2.east);
\draw[-] (A1.west) to (B6.east);
\end{tikzpicture}
