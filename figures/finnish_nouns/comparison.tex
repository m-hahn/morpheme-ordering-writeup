...
\node[rectangle,text width=1.2cm,anchor=base, fill=NA!20] (A4) at (1,-2.5) {Possessor};
...
\node[rectangle,text width=1.2cm,anchor=base, fill=NA!20] (B4) at (4,-2.5) {Possessor};
