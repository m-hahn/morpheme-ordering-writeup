...
\node[rectangle,text width=1.2cm,anchor=base] (A2) at (1,-1.5) {Honorific};
\node[rectangle,text width=1.2cm,anchor=base] (A3) at (1,-2.0) {Tense/Aspect};
\node[rectangle,text width=1.2cm,anchor=base] (A4) at (1,-2.5) {Formality};
\node[rectangle,text width=1.2cm,anchor=base] (A5) at (1,-3.0) {Mood 1};
\node[rectangle,text width=1.2cm,anchor=base] (A6) at (1,-3.5) {Mood 2};
\node[rectangle,text width=1.2cm,anchor=base] (A7) at (1,-4.0) {Connector};
\node[rectangle,text width=1.2cm,anchor=base] (A8) at (1,-4.5) {Politeness};
...
\node[rectangle,text width=1.2cm,anchor=base] (B4) at (4,-2.5) {Formality};
\node[rectangle,text width=1.2cm,anchor=base] (B5) at (4,-3.0) {Honorific};
\node[rectangle,text width=1.2cm,anchor=base] (B6) at (4,-3.5) {Mood 1};
\node[rectangle,text width=1.2cm,anchor=base] (B7) at (4,-4.0) {Mood 2};
\node[rectangle,text width=1.2cm,anchor=base] (B8) at (4,-4.5) {Connector};
