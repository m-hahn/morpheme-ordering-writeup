...
\node[rectangle,text width=1.2cm,anchor=base, fill=NA!20] (A2) at (1,-1.5) {Possessor};
...
\node[rectangle,text width=1.2cm,anchor=base, fill=NA!20] (B2) at (4,-1.5) {Possessor};
