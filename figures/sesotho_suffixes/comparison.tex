...
\node[rectangle,text width=1.2cm,anchor=base, fill=green!20] (A3) at (1,-2.0) {Voice};
...
\node[rectangle,text width=1.2cm,anchor=base, fill=blue!20] (B4) at (4,-2.5) {Tense/aspect};
