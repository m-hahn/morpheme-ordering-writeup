...
\node[rectangle,text width=2.0cm,anchor=base, fill=blue!20] (A5) at (1,-3.0) {Mood};
...
\node[rectangle,text width=2.0cm,anchor=base, fill=blue!20] (B5) at (4,-3.0) {Mood};
\node[rectangle,text width=2.0cm,anchor=base] (B6) at (4,-3.5) {Relative};
