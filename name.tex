...
\begin{figure}
    ...
    \caption{AUC Histograms for Verb Affixes: We show a smoothed histogram of baseline orderings, and the AUC values for optimized, real, and reverse orderings. For the real orderings, we also indicate what fraction of baseline grammars have higher AUC, with a Binomial confidence interval. \mhahn{TODO add missing bars}}
    \label{fig:auc_verbs}
\end{figure}
