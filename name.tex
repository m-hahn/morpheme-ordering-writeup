...
\textsc{Finnish} & \textsc{Turkish} & \textsc{Hungarian} \\
    ...
    \end{tabular}
    \caption{AUC Histograms for Noun Suffixes: We show a smoothed histogram of baseline orderings, and the AUC values for optimized, real, and reverse orderings. For the real orderings, we also indicate what fraction of baseline grammars have higher AUC, with a Binomial confidence interval. \mhahn{TODO add missing bars \& quantiles}}
    \label{fig:auc_nouns}
\end{figure}
