...
%In many cases, words can be segmented into a stem and a set of affixes, though there are
The order of morphemes within a word follows well-documented cross-linguistic tendencies, for instance, plural markers tend to be closer to noun stems than case markers.
Different explanations have been proposed for these universal tendencies.

One family of explanations holds that those affixes are closest to the root that are most relevant to the root.
...
In this work, we study a principle that unifies some of these ideas and is grounded in incremeanl processing and memory.
