...
%\end{tabular}
 ...
 \begin{figure}
 \begin{center}
 \includegraphics[width=0.7\textwidth]{figures/slots(3).pdf}
 \end{center}
...
\begin{figure} 
\begin{center}
\includegraphics[width=0.7\textwidth]{figures/examples-slots.png}
\end{center}
...
We measured accuracy by counting what fraction of all pairs of affixes within a single word from the corpus are ordered in the same relative ordering as under the real ordering (see SI Section S3 for other ways of quantifying accuracy).
...
While their notion of informativity \citep{priva2017informativity} is different from mutual information, the two quantities are related (see SI Appendix Section S4 for details).
