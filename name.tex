...
A prominent cognitively-motivated theory of morpheme ordering is the theory of complexity-based ordering \citep{plag2009suffix}.
This theory holds that affixes are closer to the root when they are less strongly separable from the base.
This can be motivated in terms of the dual processing race model of morphological access, which asserts that morphological forms can be processed either separately in terms of its components or as a whole (Baayen 1993).
...
On operationalization of separability is in terms of relative frequencies:
...
Formally (drawing on Cohen Priva 2013), they considered the informativity between a suffix $S_i$ and the preceding $S_{i-1}$ as 
\begin{equation}
