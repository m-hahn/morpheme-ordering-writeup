...
\begin{minipage}{.3\textwidth}
  ...
  \end{tabular}
    ...
    \caption{Real and optimized ordering for verb affixes.
    \mhahn{TODO colors are missing in a few places}%\mhahn{TODO make sure the language-specific morpheme slots such as ``Genitive'' and ``Clitic'' aren't confusing for the reader. One option is to color-code the slots here as in the figure(s) earlier.}
    }
