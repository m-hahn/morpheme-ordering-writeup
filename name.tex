...
Surprisal theory \citep{hale2001probabilistic, levy2008expectation} states that the processing effort on a word $w_t$ in context $w-1 ... w_{t-1}$ is proportional to its surprisal
    ...
    \text{Difficulty} \propto -\log P(w_t | w-1\dots w_{t-1}).
\end{equation}
...
However, due to limitations in human memory, human expectations in reality do not reflect the true context $w-1\dots w_{t-1}$, but some memory representation $m_t$:
...
More formally, given a function $M$ encoding contexts $w_1\dots w_{t-1}$ into memory representations $m_t$, there is a tradeoff between, on the one hand, the average surprisal $S_M$, obtained by averaging $_\log P(w_t | m_t)$ across the words in a text, and the memory capacity $H-M$, formalized as the average number of bits required to encode $m_t$.
...
\begin{equation*}
    I-t \equiv \operatorname{I}[w_t : w-0 | w-1, \dots, w_{t-1}].
\end{equation*}
...
Derivation & DERIVATION-adj-\korean{하} & HA$_2$ &	 68 & \citep[4.1.2]{yeon2010korean}\\
& DERIVATION-predicative-i & I$_2$ &	 3947 & \citep[4.1.4]{yeon2010korean} \\ \hline
Honorific & HONORIFIC-honorific-s 	& SI$_3$ & 99 & \citep[4.3.2, 4.4.1]{yeon2010korean}\\\hline
Tense/Aspect &TENSE/ASPECT-remote-past-\korean{었었} 	& ESSESS$_4$ &  56& \citep[4.5.1.2]{yeon2010korean} \\
&TENSE/ASPECT-assertive/strong-will-get 	& GET$_4$ & 355 & \citep[4.5.2.1]{yeon2010korean}\\
&TENSE/ASPECT-past &ESS$_4$ &	 9720 & \citep[4.5.1.1]{yeon2010korean}\\\hline
Formality & FORMALITY-formal-polite-p &P$_5$ &	 1761 & \citep[4.3.2]{yeon2010korean}\\\hline
Mood 1&SYNTACTICMOOD-I-guess-ri & RI$_6$ &	 70 \\
&SYNTACTICMOOD-formal-polite-ni 	&NI$_6$ & 1700 & \citep[4.3.2]{yeon2010korean}\\
&SYNTACTICMOOD-indicative-n 	&N$_6$ &5069 \\\hline
Mood 2&PRAGMATICMOOD-hortative-formal-polite-sida & SIDA$_7$ & 	 51 & Hortative, formal, polite \\
& PRAGMATICMOOD-indicative-informal-\korean{어} 	& EO$_7$ & 62 & Indicative, informal\\
& PRAGMATICMOOD-hortative-formal-nonpolite-\korean{자} & JA$_7$&	 163 & Hortative, formal, nonpolite \\
& PRAGMATICMOOD-declarative-haoche-\korean{소} &SO$_7$  &	 194 & Declarative, informal\\
& PRAGMATICMOOD-interrogative-lkka & LKKA$_7$&	 200 & Interrogative \\
& ?????-ef-\korean{오} & O$_7$ &	 226 \\
& PRAGMATICMOOD-ji & JI$_7$ &	 260 & \citep[4.2.2-3]{yeon2010korean}\\
& PRAGMATICMOOD-interrogative-ka 	& KA$_7$ & 485 & Interrogative & \\
& PRAGMATICMOOD-ra &RA$_7$ &	 959 & & \\
& PRAGMATICMOOD-declarative-da & DA$_7$ &	 23035 & Declarative & \citep[4.3.2]{yeon2010korean}\\\hline
Polite & POLITE-polite-\korean{요} & YO$_8$&	 267 \\
\end{tabular}
