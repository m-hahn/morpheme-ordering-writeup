...
Imperative  && \korean{해라, 하여라}  & \korean{해}  & \korean{해요}  & \korean{합시오}  \\
  ...
  && -RA$_7$ & -\textsc{eo}$_7$ & -\textsc{eo}$_7$-\textsc{yo}$_8$ & -\textsc{p}$_5$-\textsc{si}$_3$O \\
...
\begin{tabular}{ll||llllllllllllll}
 ...
 DNP & A & yaparım & yaparsın &  	yapar & yaparız & yaparsınız &  	yaparlar \\
                    &  & -AR-IM & -AR-\textsc{si}$_3$N &  	-AR & -AR-IZ & -AR-\textsc{si}$_3$NIZ &  	-AR-LAR \\ \hline
                & I & yapıyorum & yapıyorsun & 	yapıyor &	yapıyoruz &	yapıyorsunuz &	yapıyorlar \\
                &  & -IYOR-UM & -IYOR-SUN & 	-IYOR &	-IYOR-UZ &	-IYOR-\textsc{si}$_3$NIZ &	-IYOR-LAR \\ \hline
                & Pr  & yapacağım &	yapacaksın 	& yapacak 	& yapacağız &	yapacaksınız &	yapacaklar \\ 
                &   & -ACAK-IM &	-ACAK-\textsc{si}$_3$N 	& -ACAK 	& -ACAK-IZ &	-ACAK-\textsc{si}$_3$NIZ &	-ACAK-LAR \\ \hline\hline
        DP    & Pe &yaptım &	yaptın &	yaptı &	yaptık &	yaptınız &	yaptılar \\
              &  &-TI-IM &	-TI-\textsc{si}$_3$N &	-TI &	-TI-K &	-TI-\textsc{si}$_3$NIZ &	-TI-LAR \\ \hline
                & I & yapıyordum &	yapıyordun &	yapıyordu &	yapıyorduk &	yapıyordunuz &	yapıyorlardı \\ 
                &  & -IYOR-DU-IM &	-IYOR-DU-\textsc{si}$_3$N &	-IYOR-DU &	-IYOR-DU-K &	-IYOR-DU-\textsc{si}$_3$NIZ &	-IYOR-LAR-DU \\ \hline\hline
 I     & Pe & yapmışım &	yapmışsın &	yapmış &	yapmışız &	yapmışsınız &	yapmışlar \\
       &  & -MIS-IM &	-MIS-\textsc{si}$_3$N &	-MIS &	-MIS-IZ &	-MIS-\textsc{si}$_3$NIZ &	-MIS-LAR \\ \hline
               & A & yaparmışım &	yaparmışsın &	yaparmış &	yaparmışız &	yaparmışsınız& 	yaparlarmış \\ 
            &  & -AR-MIS-IM &	-AR-MIS-\textsc{si}$_3$N &	-AR-MIS &	-AR-MIS-IZ &	-AR-MIS-\textsc{si}$_3$NIZ& 	-AR-LAR-MIS \\ \hline
...
Ind & Pres   &  I    & teszek &	teszel &	tesz &	teszünk &	tesztek &	tesznek \\
 ...
 &    &      & -\textsc{ek} &	-\textsc{el} &	- &	-\textsc{unk} &	-\textsc{tek} &	-\textsc{nek} \\ \hline
...
&&&ismertem &	ismertél &	ismert &	ismertünk &	ismertetek &	ismertek \\
	    &  &         &-\textsc{t}-EM &	-\textsc{t}-EL &	-T &	-\textsc{t}-UNK &	-\textsc{t}-TEK &	-\textsc{t}-\textsc{ek} \\ \hline
