...
\begin{minipage}{.3\textwidth}
  ...
  \end{minipage}
  \\
  \textbf{Korean}  & \textbf{Japanese} & \textbf{Sesotho Prefixes} \\
      \begin{minipage}{.3\textwidth}
...
\begin{minipage}{.3\textwidth}
  ...
  \include{figures/japanese/comparison-opt-uni}
    \end{minipage}
\end{tabular}
    \caption{Comparing optimized orders with the universal order described by \citep{bybee-morphology-1985} \mhahn{TODO I'll have to exclude rare categories like UNKNOWN from Korean.}.}
    \label{fig:my_label}
\end{figure}
...
\begin{enumerate}
    ...
    \item We partition Mood suffixes into two slots, as these can be combined. Frequent elements of the Mood I slot are -\textsc{n}-, -\textsc{ni}- \citep[4.3.2]{yeon2010korean}.
...
\multirow{6}{*}{Interrogative} & \multirow{3}{*}{Non-past} & \korean{하느냐} & \korean{해}  & \korean{해요}  & \korean{합니까} \\
 ...
 &  & -NYA$_7$ &  -EO$_7$ &  -EO$_7$-YO$_8$ & -P$_5$-NI$_6$+KKA$_7$ \\
 ...
 \hline
              ...
              &  & -ESS$_4$-NYA$_7$ &  -ESS$_4$-EO$_7$ &  -ESS$_4$-EO$_7$+YO$_8$ &  -ESS$_4$-P$_5$-NI$_6$-KKA$_7$\\
...
Imperative  && \korean{해라, 하여라}  & \korean{해}  & \korean{해요}  & \korean{합시오}  \\
  ...
  && -RA$_7$ & -EO$_7$ & -EO$_7$-YO$_8$ & -P$_5$-SIO \\
...
&& SI-NYA & SI-EO & SI-EO-YO & SI-P-NI$_6$-KKA$_7$ \\
& &   --     &   --   &   \korean{하+시+어+요}             &  --        \\
\hline
& Past & \korean{하셨느냐} & \korean{하셨어} & \korean{하셨어요} & \korean{하셨습니까} \\
&      & SI-ESS-NYA & SI-ESS-EO          & SI-ESS-EO-YO & SI-ESS-P-NI$_6$-KKA$_7$ \\
& &        &      &                &          \\
\hline
